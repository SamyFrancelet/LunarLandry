...
\begin{center}
\fontsize{14.4}{14.4}\selectfont{$\overrightarrow{F}= M \cdot \overrightarrow{a}$}\\
\end{center}
Qui est transformé pour l’accélération en chute libre par :
\begin{center}
\fontsize{14.4}{14.4}\selectfont{$\overrightarrow{F}_{grav} = M \cdot \overrightarrow{g}$}\\
\end{center}
...
\begin{center}
\fontsize{14.4}{14.4}\selectfont{$\overrightarrow{F}_{friction} = -k \cdot \overrightarrow{v}$}\\
\end{center}
